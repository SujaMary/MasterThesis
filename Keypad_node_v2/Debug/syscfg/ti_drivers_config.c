...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    /* STBY */
    GPIOCC26XX_DIO_12 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW,
    /* GPIO_COL_1 */
    ...
    /* GPIO_ROW_1 */
    GPIOCC26XX_DIO_29 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_NONE,
    /* GPIO_ROW_2 */
    GPIOCC26XX_DIO_30 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_NONE,
    /* GPIO_ROW_3 */
    GPIOCC26XX_DIO_00 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_NONE,
    /* GPIO_ROW_4 */
    GPIOCC26XX_DIO_01 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_NONE,
};
...
const uint_least8_t GPIO_COL_1_CONST = GPIO_COL_1;
const uint_least8_t GPIO_COL_2_CONST = GPIO_COL_2;
const uint_least8_t GPIO_COL_3_CONST = GPIO_COL_3;
const uint_least8_t GPIO_COL_4_CONST = GPIO_COL_4;
const uint_least8_t GPIO_ROW_1_CONST = GPIO_ROW_1;
const uint_least8_t GPIO_ROW_2_CONST = GPIO_ROW_2;
const uint_least8_t GPIO_ROW_3_CONST = GPIO_ROW_3;
const uint_least8_t GPIO_ROW_4_CONST = GPIO_ROW_4;
...
const PIN_Config BoardGpioInitTable[CONFIG_PIN_COUNT + 1] = {
    ...
    CONFIG_PIN_14 | PIN_INPUT_EN | PIN_PULLUP | PIN_IRQ_DIS,
    /* Parent Signal: GPIO_ROW_4 GPIO Pin, (DIO1) */
    CONFIG_PIN_15 | PIN_INPUT_EN | PIN_PULLUP | PIN_IRQ_DIS,
