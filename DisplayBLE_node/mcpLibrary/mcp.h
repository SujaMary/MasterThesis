...
extern uint8_t transmitBuffer  [PAYLOAD_SIZE+1];
extern uint8_t receiveBuffer   [PAYLOAD_SIZE+1];
...
//int mcp_msg_read ( RXB_t rx_buffer, uint16_t *msg, uint8_t *count, uint32_t *ID, bool *IDE, bool *RTR ); //--last working
